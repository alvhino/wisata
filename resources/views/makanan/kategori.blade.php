                ...
                @foreach($wisata as $data)
                    <div class="col-md-4 mb-4">
                        <div class="card h-100">
                            ...
                            @else
                                <img src="{{ asset('foto/default.jpg') }}" class="card-img-top" alt="{{ $data->nama_wisata }}">
                            @endif
                            
                            <div class="card-body">
                                <h1 class="card-title text-center">{{ $data->nama_wisata }}</h1>
                            ...
                            <div class="card-footer">
                                <a href="{{ url('dashboard/detail', $data->id_wisata) }}" class="btn btn-primary">Detail</a>
...
<div class="text-center mt-5">
    ...
    <footer>
        <p>&copy; 2024 Destinasi Wisata Jepara</p>
    </footer>
