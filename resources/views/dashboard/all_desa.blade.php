...
<head>
    ...
    <title>Semua desa di Jepara</title>
...
<div class="container content">
    <h2 class="text-center mb-4">Semua desa wisata di Jepara</h2>
            ...
            <div class="col-md-4 text-center mb-4">
                <div class="card h-100 shadow-sm">
                    ...
                    <div class="card-footer d-flex justify-content-between align-items-center">
                        <a class="btn btn-primary btn-sm" href="{{ url('dashboard/detail_desa', $data->id_desa) }}">Detail</a>
