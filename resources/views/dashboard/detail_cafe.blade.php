...
<div class="container mt-5">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card mb-4">
                <img src="{{ $data->img ? asset('foto/' . $data->img) : asset('foto/default.jpg') }}" alt="{{ $data->nama_cafe }}" class="image-border">
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p><strong>Jam Operasional:</strong> {{ $data->jam_tutup }}</p>
                </div>
            </div>
        </div>
